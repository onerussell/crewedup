<?php /* Smarty version 2.6.11, created on 2010-05-24 20:05:35
         compiled from mods/employer/_left_box.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'wordwrap', 'mods/employer/_left_box.html', 24, false),)), $this); ?>
			<!-- Contact Box -->
...
" alt="<?php if (2 == $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['status']):  echo $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['company'];  else:  echo $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['name']; ?>
 <?php echo $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['lname'];  endif; ?>" /></a></div>
...
empty.gif" alt="<?php if (2 == $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['status']):  echo $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['company'];  else:  echo $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['name']; ?>
 <?php echo $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['lname'];  endif; ?>" /></a>
                         </div>
                        <?php endif; ?>
						</td>
...
"><?php if (2 == $this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['status']):  echo ((is_array($_tmp=$this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['company'])) ? $this->_run_mod_handler('wordwrap', true, $_tmp) : smarty_modifier_wordwrap($_tmp));  else:  echo ((is_array($_tmp=$this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['name'])) ? $this->_run_mod_handler('wordwrap', true, $_tmp) : smarty_modifier_wordwrap($_tmp)); ?>
 <?php echo ((is_array($_tmp=$this->_tpl_vars['lfriends'][$this->_sections['i']['index']]['lname'])) ? $this->_run_mod_handler('wordwrap', true, $_tmp) : smarty_modifier_wordwrap($_tmp));  endif; ?></a></td>
				...
				<?php if (! $this->_tpl_vars['is_user'] || $this->_tpl_vars['is_public']): ?> 
				    <img src="<?php echo $this->_tpl_vars['imgDir']; ?>
toby_ico.gif" alt="Blog" style="float:left;margin-top:-10px" /><?php echo ((is_array($_tmp=$this->_tpl_vars['ui']['company'])) ? $this->_run_mod_handler('wordwrap', true, $_tmp) : smarty_modifier_wordwrap($_tmp)); ?>
 <a href="<?php echo $this->_tpl_vars['siteAdr']; ?>
...
gear_add_ico.gif" alt="Plus" />Post a new entry</a></p>
                ...
                <p><a href="<?php echo $this->_tpl_vars['siteAdr']; ?>
blog<?php echo $this->_tpl_vars['ui']['uid']; ?>
?what=rss">Subscribe to the blog</a><img src="<?php echo $this->_tpl_vars['imgDir']; ?>
