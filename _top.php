<?php
    ...
    // ini_set('include_path','.;'.BPATH.INC_PATH.'includes/libs/PEAR');
...
#    ini_set('display_errors'        , ERROR_DISPLAY);
    ...
    $gSmarty -> load_filter('output', 'replace_op_all');
    ...
    $gSmarty -> assign('imgDir'           , PATH_ROOT.'includes/templates/images/');
    $gSmarty -> assign('stlDir'           , PATH_ROOT.'includes/templates/css/');
