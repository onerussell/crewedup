...
// Include base configuration
    ...
    // ini_set('include_path','.;'.BPATH.'siteadmin/includes/libs/PEAR');
...
try
   {
    ...
    // <  init pagging class  >
    require CLASS_PATH.'View/Acc/SimplePagging.class.php';
    $gPage = new View_Acc_SimplePagging($glObj, RESULTS_COUNTER, 'pstart' );
    $glObj['page'] =& $gPage;
   
    // -----------------------------------------------------------------
    // < init history class >
    require CLASS_PATH.'Model/Maintenance/History.class.php';
    ...
    require CLASS_PATH.'Model/Security/Be/Admin_Users.php';
    ...
    // Admin modules
    require CLASS_PATH.'Model/Security/Be/Modules.php';
