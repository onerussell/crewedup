...
require_once(BX . 'HTML/Common.php');


$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES'] =
        array(
            'group'         =>array(BX . 'HTML/QuickForm/group.php','HTML_QuickForm_group'),
            'hidden'        =>array(BX . 'HTML/QuickForm/hidden.php','HTML_QuickForm_hidden'),
            'reset'         =>array(BX . 'HTML/QuickForm/reset.php','HTML_QuickForm_reset'),
            'checkbox'      =>array(BX . 'HTML/QuickForm/checkbox.php','HTML_QuickForm_checkbox'),
            'file'          =>array(BX . 'HTML/QuickForm/file.php','HTML_QuickForm_file'),
            'image'         =>array(BX . 'HTML/QuickForm/image.php','HTML_QuickForm_image'),
            'password'      =>array(BX . 'HTML/QuickForm/password.php','HTML_QuickForm_password'),
            'radio'         =>array(BX . 'HTML/QuickForm/radio.php','HTML_QuickForm_radio'),
            'button'        =>array(BX . 'HTML/QuickForm/button.php','HTML_QuickForm_button'),
            'submit'        =>array(BX . 'HTML/QuickForm/submit.php','HTML_QuickForm_submit'),
            'select'        =>array(BX . 'HTML/QuickForm/select.php','HTML_QuickForm_select'),
            'hiddenselect'  =>array(BX . 'HTML/QuickForm/hiddenselect.php','HTML_QuickForm_hiddenselect'),
            'text'          =>array(BX . 'HTML/QuickForm/text.php','HTML_QuickForm_text'),
            'textarea'      =>array(BX . 'HTML/QuickForm/textarea.php','HTML_QuickForm_textarea'),
            'link'          =>array(BX . 'HTML/QuickForm/link.php','HTML_QuickForm_link'),
            'advcheckbox'   =>array(BX . 'HTML/QuickForm/advcheckbox.php','HTML_QuickForm_advcheckbox'),
            'date'          =>array(BX . 'HTML/QuickForm/date.php','HTML_QuickForm_date'),
            'static'        =>array(BX . 'HTML/QuickForm/static.php','HTML_QuickForm_static'),
            'header'        =>array(BX . 'HTML/QuickForm/header.php', 'HTML_QuickForm_header'),
            'html'          =>array(BX . 'HTML/QuickForm/html.php', 'HTML_QuickForm_html'),
            'hierselect'    =>array(BX . 'HTML/QuickForm/hierselect.php', 'HTML_QuickForm_hierselect'),
            'autocomplete'  =>array(BX . 'HTML/QuickForm/autocomplete.php', 'HTML_QuickForm_autocomplete'),
            'xbutton'       =>array(BX . 'HTML/QuickForm/xbutton.php','HTML_QuickForm_xbutton')
        );

$GLOBALS['_HTML_QuickForm_registered_rules'] = array(
    'required'      => array('html_quickform_rule_required', BX . 'HTML/QuickForm/Rule/Required.php'),
    'maxlength'     => array('html_quickform_rule_range',    BX . 'HTML/QuickForm/Rule/Range.php'),
    'minlength'     => array('html_quickform_rule_range',    BX . 'HTML/QuickForm/Rule/Range.php'),
    'rangelength'   => array('html_quickform_rule_range',    BX . 'HTML/QuickForm/Rule/Range.php'),
    'email'         => array('html_quickform_rule_email',    BX . 'HTML/QuickForm/Rule/Email.php'),
    'regex'         => array('html_quickform_rule_regex',    BX . 'HTML/QuickForm/Rule/Regex.php'),
    'lettersonly'   => array('html_quickform_rule_regex',    BX . 'HTML/QuickForm/Rule/Regex.php'),
    'alphanumeric'  => array('html_quickform_rule_regex',    BX . 'HTML/QuickForm/Rule/Regex.php'),
    'numeric'       => array('html_quickform_rule_regex',    BX . 'HTML/QuickForm/Rule/Regex.php'),
    'nopunctuation' => array('html_quickform_rule_regex',    BX . 'HTML/QuickForm/Rule/Regex.php'),
    'nonzero'       => array('html_quickform_rule_regex',    BX . 'HTML/QuickForm/Rule/Regex.php'),
    'callback'      => array('html_quickform_rule_callback', BX . 'HTML/QuickForm/Rule/Callback.php'),
    'compare'       => array('html_quickform_rule_compare',  BX . 'HTML/QuickForm/Rule/Compare.php')
);
...
class HTML_QuickForm extends HTML_Common {
    ...
    {
        include_once(BX . 'HTML/QuickForm/RuleRegistry.php');
    ...
    */
    function &defaultRenderer()
    {
        if (!isset($GLOBALS['_HTML_QuickForm_default_renderer'])) {
            include_once(BX . 'HTML/QuickForm/Renderer/Default.php');
    ...
    {
        include_once BX . 'HTML/QuickForm/Renderer/Array.php';
