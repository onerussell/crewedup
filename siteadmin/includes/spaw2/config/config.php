...
$spf = str_replace(SpawConfig::getStaticConfigValue("DOCUMENT_ROOT"),'',SpawConfig::getStaticConfigValue("SPAW_ROOT"));
$spf = '/'.substr($spf, 0, strpos('/', $spf)); 
SpawConfig::setStaticConfigItem('SPAW_DIR_FILES', $spf);
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR_FILES').'files/flash/', //SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/flash/',
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR_FILES').'files/images/', //SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/images/',
      'caption' => 'Images',
      'params'  => array(
    ...
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR_FILES').'files/files/', //SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/files/',
      'fsdir'   => SpawConfig::getStaticConfigValue('SPAW_DIR_FILES').'files/files/', //SpawConfig::getStaticConfigValue('SPAW_ROOT').'uploads/files/', // optional absolute physical filesystem path
      'caption' => 'Files', 
      'params'  => array(
